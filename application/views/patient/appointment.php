...
WHERE patient.pid = $userid AND (appointment.status IS NULL OR appointment.status = '')
";
    ...
    <td class="menu-btn menu-icon-settings" style="background-image: url('<?= base_url('assets/img/icons/settings.svg') ?>')">
        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    <td width="13%" >
                    <a href="<?= base_url('patient'); ?>/appointment" ><button  class="login-btn btn-primary-soft btn btn-icon-back"  style="padding-top:11px;padding-bottom:11px;margin-left:20px;width:125px"><font class="tn-in-text">Back</font></button></a>
                    </td>
                    <td>
                ...
                <td width="10%" >
                    <a href="<?= base_url('patient'); ?>/history" ><button  class="login-btn btn-primary-soft btn "  style="padding-top:11px;padding-bottom:11px;margin-left:50px;width:125px"><font class="tn-in-text">History</font></button></a>
                    </td>
                    <td>
...
if($result->num_rows()==0){
    ...
    <a class="non-style-link" href="'.base_url('patient').'/appointment"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">  Show all Appointments  </font></button>
    </a>
    </center>
    <br><br><br><br>
    </td>
                        ...
                        <div class="h3-search">
                                ...
                                <div class="h3-search">
                                    '.substr($docname,0,30).'
                                                                ...
                                                                <br>
                                                                <a href="'.base_url('patient').'/appointment?action=drop&id='.$appoid.'&title='.$title.'&doc='.$docname.'" ><button  class="login-btn btn-primary-soft btn "  style="padding-top:11px;padding-bottom:11px;width:100%"><font class="tn-in-text">Cancel Booking</font></button></a>
                                                        </div>
        ...
        if($action=='booking-added'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <br><br>
                        ...
                        <a class="close" href="'.base_url('patient').'/appointment">&times;</a>
                        <div class="content">
                        ...
                        <a href="'.base_url('patient').'/appointment" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text">&nbsp;&nbsp;OK&nbsp;&nbsp;</font></button></a>
                        <br><br><br><br>
                        </div>
                    </center>
            </div>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div style="display: flex;justify-content: center;">
                        <a href="'.base_url('patient').'/cancelAppointment?id='.$id.'" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"<font class="tn-in-text">&nbsp;Yes&nbsp;</font></button></a>&nbsp;&nbsp;&nbsp;
                        <a href="'.base_url('patient').'/appointment" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text">&nbsp;&nbsp;No&nbsp;&nbsp;</font></button></a>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        <h2></h2>
                        <a class="close" href="'.base_url('patient').'/doctors">&times;</a>
                        <div class="content">
                            eDoc Web App<br>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td colspan="2">
                                    <a href="'.base_url('patient').'/doctors"><input type="button" value="OK" class="login-btn btn-primary-soft btn" ></a>
