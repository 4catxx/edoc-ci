...
<tr class="menu-row">
    <td class="menu-btn menu-icon-appoinment">
        <a href="<?= base_url('admin'); ?>/appointment" class="non-style-link-menu"><div><p class="menu-text">Janji Temu</p></a></div>
    </td>
</tr>
<tr class="menu-row">
    <td class="menu-btn menu-icon-patient  menu-active menu-icon-patient-active">
        <a href="<?= base_url('admin'); ?>/patient" class="non-style-link-menu  non-style-link-menu-active"><div><p class="menu-text">Pasien</p></a></div>
    </td>
</tr>
    ...
    <?php
        ...
        $list11 = $this->db->select('pname, pemail')->get('patient');
    ...
    if($this->input->get()){
        ...
        $query = $this->db->get_where('patient', array('pid' => $id));
        $row = $query->row_array();
        if (isset($row))
        {
            $name = $row['pname'];
            ...
            <div id="popup1" class="overlay">
                    <div class="popup">
                    <center>
                        <a class="close" href="'.base_url('admin').'/patient">&times;</a>
                        <div class="content">
                    ...
                    <tr> 
                    <td class="label-td" colspan="<EUGPSCoordinates>2"> 
                    <label for="<EUGPSCoordinates>" class="<EUGPSCoordinates>-label">Tanggal Lahir: </label> 
                    </td> 
                    </tr> 
                    <tr> 
                    <td class="<EUGPSCoordinates>" colspan="<EUGPSCoordinates>"> 
                    '.$dob.'<br><br> 
                    </td> 
                            ...
                            <tr>
                                <td colspan="2">
                                    <a href="'.base_url('admin').'/patient"><input type="button" value="OK" class="login-btn btn-primary-soft btn" ></a>
