...
<td width="10%">
    <button  class="btn-label"  style="display: flex;justify-content: center;align-items: center;"><img src="../img/calendar.svg" width="100%"></button>
                ...
                <?php
$this->db->select('appointment.appoid, schedule.scheduleid, schedule.title, doctor.docname, patient.pname, schedule.scheduledate, schedule.scheduletime, appointment.apponum, appointment.appodate');
$this->db->from('schedule');
$this->db->join('appointment', 'schedule.scheduleid = appointment.scheduleid');
$this->db->join('patient', 'patient.pid = appointment.pid');
$this->db->join('doctor', 'schedule.docid = doctor.docid');
