...
<tr class="menu-row" >
        ...
        <div class="dash-body" style="margin-top: 15px">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                        ...
                        <td width="13%" >
                    <a href="'.base_url('dokter').'/settings" ><button  class="login-btn btn-primary-soft btn btn-icon-back"  style="padding-top:11px;padding-bottom:11px;margin-left:20px;width:125px"><font class="tn-in-text">Back</font></button></a>
                    </td>
                    <td>
...
<div class="h3-dashboard" style="font-size: 15px;">
    Ubah Detail Akun Anda & Ganti Kata Sandi
</div>
...
<tr>
    <td style="width: 25%;">
        <a href="?action=drop&id='.$userid.'&name='.$username.'" class="non-style-link">
            <div class="dashboard-items setting-tabs" style="padding:20px;margin:auto;width:95%;display: flex;">
    ...
    if($_GET){
        ...
        if($action=='drop'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        <h2>Are you sure?</h2>
                        <a class="close" href="'.base_url('admin').'/settings">&times;</a>
                        <div class="content">
                        ...
                        <a href="'.base_url('admin').'/settings" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text">&nbsp;&nbsp;No&nbsp;&nbsp;</font></button></a>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="spec" class="form-label">Spesialiss: </label>
                            ...
                            <tr>
                                <td colspan="2">
                                    <a href="'.base_url('dokter').'/settings"><input type="button" value="OK" class="login-btn btn-primary-soft btn" ></a>
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <form action="'.base_url('dokter').'/update" method="POST" class="add-new-form">
                                            <label for="Email" class="form-label">Email: </label>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            ...
                                            $list11 = $this->db->query("select * from specialties;");
            ...
            echo '
                <div id="popup1" class="overlay">
                        ...
                        <br><br><br><br>
                            ...
                            <a href="'.base_url('dokter').'/settings" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text">&nbsp;&nbsp;OK&nbsp;&nbsp;</font></button></a>
